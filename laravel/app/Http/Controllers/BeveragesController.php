...
class BeveragesController extends Controller
{
    ...
    {   
        ...
        $itemData = $ItemsModel->getItem('BEVERAGES');
        $temp = array();
        ...
        return View::make('items.beverages-item', compact('itemData', 'itemColumn'));
    ...
    public function getBeveragesitem()
    {
        // $foodData = $this->initiateFoodItem()->$getFoodItem('VEGETABLES');
        return response()->json(array("BEV!"));
        // $temp = array();
