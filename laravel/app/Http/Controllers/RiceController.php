...
class RiceController extends Controller
{
    ...
    {   
        ...
        $itemData = $ItemsModel->getItem('RICE');
        $temp = array();
        ...
        return View::make('items.rice-item', compact('itemData', 'itemColumn'));
    ...
    public function getRiceitem()
    {
        // $foodData = $this->initiateFoodItem()->$getFoodItem('VEGETABLES');
        return response()->json(array("RICE!"));
        // $temp = array();
