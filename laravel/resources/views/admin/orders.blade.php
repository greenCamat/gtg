    ...
    @include('sidebar')
        <div class="page-content rfloat">
            ...
            <div class="content-header clearfix">
                <h1 class="lfloat">Orders</h1>
                <h1 class="lfloat rfloat">Date today</h1>
            </div>
                <div class="main-content">
                    <div class="head clearfix">
                        <!--<h2 class="lfloat">Overview</h2>
                        <input type="text" class="inpt-calendar rfloat" value="Date Today">-->
                    </div>
                <ul class="overview-wrapper clearfix">
                    ...
                    <div class="locations rfloat clearfix">
                        <h2 class="lfloat">List of Purchased</h2>
