            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Fruits</h4>
                        <p>We deliver to you fresh!</p>
                        <a id="item_fruits" href="/shop/fruits" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_meatfish" href="/shop/meatfish" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_condiments" href="/shop/condiments" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Dairy</h4>
                        <p>Eggs, Milks etc..</p>
                        <a id="item_dairy" href="/shop/dairy" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
             <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_chipsnacks" href="/shop/chipsnacks" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
             <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_instantfood" href="/shop/instantfood" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Rice</h4>
                        <p>Canned food and One step cooking.</p>
                        <a id="item_rice" href="/shop/rice" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_supplies" href="/shop/supplies" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_beverages" href="/shop/beverages" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Toiletries</h4>
                        <p>Bath and Beyond</p>
                        <a id="item_toiletries" href="/shop/toiletries" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a id="item_otherservices" href="/shop/otherservices" class="btn btn-primary">Shop</a>
                    </div>
                </div>
            </div>
        </div>
